...
def get_customization(uid):
    try:
        ...
        if result is None:
            ...
            return {"theme": "light"}, 200, {"Content-Type": "application/json"}

        return {"theme": result[2]}, 200, {"Content-Type": "application/json"}
...
def post_customization(uid):
    try:
        ...
        return {"theme": theme}, 200, {"Content-Type": "application/json"}
