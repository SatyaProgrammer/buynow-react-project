...
const Signup = (props) => {
    ...
    return (
        ...
        >
            <div
                className={
                    nextPage ? "w-96 h-full relative" : "w-fit h-full relative"
                }
            >
                <div
                    ref={mainRef}
                    className={
                        nextPage
                            ? "hidden"
                            : " w-80 sm:w-96 bg-white shadow-lg flex items-center justify-cente gap-6 rounded-md my-4"
                    }
                >
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        >
                                            <div className="text-xs font-normal text-cldanger">
                                                Must input valid email for this
                                                field
                                            </div>
                                        </div>
                                    </div>
                ...
                <div
                    className={
                        nextPage
                            ? "w-80 sm:w-96 bg-white shadow-lg flex flex-col gap-6 rounded-md absolute  top-0 translate-x-none opacity-100 transition-all duration-200 my-4"
                            : "hidden"
                    }
                >
