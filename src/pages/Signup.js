...
const Signup = (props) => {
  ...
  return (
    ...
    >
      <div className={nextPage ? "w-96 h-full relative" : "w-fit h-fit relative"}>
        <div
          ref={mainRef}
          className={
            nextPage
        ...
        <div
          className={
            nextPage
              ? "w-80 sm:w-96 bg-white shadow-lg flex flex-col gap-6 rounded-md absolute  top-0 translate-x-none opacity-100 transition-all duration-200"
              : "w-80 sm:w-96 bg-white shadow-lg flex flex-col gap-6 rounded-md absolute  top-0 translate-x-full opacity-0 transition-all duration-200"
          }
        >
          <div className="p-4 flex flex-col gap-4">
            ...
            {skipProfile ? (
              <div className="text-sm text-center">
                <span className="text-cldark font-semibold">Setup now?</span>
                <span
              ...
              <div className="text-sm text-center">
                <span className="text-cldark font-semibold">Setup later?</span>
                <span
                  onClick={() => {
                    setSkipProfile(true);
                    setProfileSetup(false);
